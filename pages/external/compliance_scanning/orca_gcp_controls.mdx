# Orca GCP Control Details

### How to Use This Document

Below you will find detailed information for each released Orca GCP control. Remediations for the controls are found below using manual steps (console-based) and automated steps (Terraform-based). Follow the manual steps if you do not use Terraform to manage your resources, or add the Terraform configurations to your Terraform modules. **Please thoroughly test and adapt the Terraform configurations as needed**.
...
<Controls file={"gcp-controls.yaml"} />
